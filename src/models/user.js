...
import { query as queryUsers, list, submit, update, detail, remove, grant, updatepassword } from '../services/user';
...
export default {
  ...
  effects: {
    ...
    *fetchInit({ payload }, { call, put }) {
      ...
      let sexName = [];
      const responseDict = yield call(dict, {'code': val});
      if (responseDict.success) {
        sexName = responseDict.data;
      }
