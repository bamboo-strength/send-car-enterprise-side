export default {
  ...
  'validation.password.required.length': '请输入长度位6-16位字符！',
  'validation.password.required.two-types': '请输入包含大小字母、数字、符号中至少2种！',
  ...
  'validation.password.strength.short': '强度：弱',
