...
import { MERVEHIVL_LIST, MERVEHIVL_REMOVE } from '../../../actions/merVehicle';
...
@Form.create()
class NetWorkMyCars extends React.Component {
  constructor(props) {
    super(props);
  ...
  showOper = (vehicle, truckno) => {
    ...
    ActionSheet.showActionSheetWithOptions({
      ...
      (buttonIndex) => {
        ...
        if ( auditStatus !== 1 && buttonIndex === 3) {  // 修改
          router.push(
            {
              pathname: `/driverSide/personal/carCertification/`,
              state: { truckId: id },
            },
          );
        }
    ...
    return (
      <div>
        <NavBar
          ...
          rightContent={[
            <a onClick={() => router.push('/driverSide/personal/carCertification2')}>车辆认证</a>,
          ]}
        >我的车辆
        </NavBar>
