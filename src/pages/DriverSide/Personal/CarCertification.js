...
@Form.create()
class CarCertification extends React.Component {
  state = {
    //  files: [],
    loading: false,
    imgloading: false,
    ...
    form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        /*   if(values.netWeight === ""){
           ...
           if(values.axles === undefined){
             values.axles = ""
           }
           if(values.trucktype === undefined){
             values.trucktype = ""
           } */
      ...
      <div>
        ...
        <div className='am-list'>
          ...
          </Card>
          {
            ...
            //  :
            //   <Button type="primary" style={{ width: '50%', margin: '20px auto',display:'none' }} onClick={this.toAudit} loading={loading}>
            //     提交
            //   </Button>
          }
        </div>
...
export default CarCertification;
