    ...
    return (
      <div className={styles.main}>
        ...
        <Card className={styles.card} bordered={false}>
          ...
          <p>&emsp;&emsp;尊敬的客户您好，欢迎您访问______________________网站（以下简称：网站）。在您注册成为网站会员之前，请您务必认真阅读和理解《网站用户注册协议》（以下简称：协议）中所有的条款。您须完全同意协议中所有的条款，才可以注册成为本网站的会员，使用里面的服务。您在网站的注册和操作均将被视为是您对协议所有条款及内容的自愿接受。</p>
          <p>一、声明</p>
          <p>（一）网站内在线产品的所有权归______________________所有。</p>
          ...
          <p>（三）您使用网站提供的服务如产生争议，原则上双方协商解决，协商不成可向_____________________仲裁机构申请仲裁或_____________________人民法院提起诉讼。</p>
