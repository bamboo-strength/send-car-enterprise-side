...
@Form.create()
class DrawBillAgreement extends PureComponent {
  ...
  render() {
    ...
    return (
      <div className={styles.main}>
        ...
        <p>&emsp;&emsp;尊敬的客户您好，欢迎您访问<u>山东矩阵软件工程股份有限公司</u>网站（以下简称：网站或APP，小程序）。在您注册成为网站会员之前，请您务必认真阅读和理解《网站用户注册协议》（以下简称：协议）中所有的条款。您须完全同意协议中所有的条款，才可以注册成为本网站的会员，使用里面的服务。您在网站的注册和操作均将被视为是您对协议所有条款及内容的自愿接受。</p>
        <p>一、声明</p>
        <p>（一）网站内在线产品的所有权归<u>山东矩阵软件工程股份有限公司</u>所有。</p>
        ...
        <p>（七）本网站提供免费注册和有偿服务，您的注册均是自愿行为，注册成功后，您可以得到网站更加完善的有偿服务。</p>
        ...
        <p>三、注册会员权利和义务</p>
        <p>（一）注册会员有权用本网站提供的服务功能，同时我们为给您提供更便捷的信息服务，当您开启设备服务功能时我们将收集并获取您的位置等个人信息，以实现我们为您提供更优质的周边生活服务的目的。</p>
        ...
        <p>（五）您在使用本网站服务时，同意且接受本网站提供的各类信息服务，并知晓相关有偿服务收费标准。</p>
        ...
        <p>（三）您使用网站提供的服务如产生争议，原则上双方协商解决，协商不成可向<u>山东矩阵软件工程股份有限公司所在地</u>仲裁机构申请仲裁或<u>山东矩阵软件工程股份有限公司所在地</u>人民法院提起诉讼。</p>
...
export default DrawBillAgreement;
