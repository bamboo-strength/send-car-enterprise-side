            ...
            <Row gutter={24}>
              <Col span={20}>
                <FormItem {...formAllItemLayout} label="字典编号">
                  ...
                  })(<Input disabled={func.notEmpty(detail.code)} placeholder="请输入字典编号" maxLength={60} />)}
                </FormItem>
              </Col>
            </Row>
            <Row gutter={24}>
              ...
              <Col span={10}>
                <FormItem {...formItemLayout} className={styles.inputItem} label="字典排序">
                  ...
                  })(<InputNumber placeholder="请输入字典排序" maxLength={4} />)}
                </FormItem>
              </Col>
            </Row>
            <Row gutter={24}>
              ...
              <Col span={10}>
                <FormItem {...formItemLayout} className={styles.inputItem} label="字典键值">
                  ...
                  })(<InputNumber min={-1} placeholder="请输入字典键值" maxLength={4} />)}
                </FormItem>
              </Col>
            </Row>
          </Card>
            ...
            <Row gutter={24}>
              <Col span={20}>
                <FormItem {...formAllItemLayout} label="字典备注">
                  {getFieldDecorator('remark')(<TextArea rows={4} placeholder="请输入字典备注" maxLength={40} />)}
                </FormItem>
              </Col>
            </Row>
          </Card>
