...
import {queryVehicleDetail} from '@/services/commonBusiness';
...
@Form.create()
class CommonBusinessVehicleView extends PureComponent {
  ...
  componentWillMount() {
    ...
    dispatch(TABLEEXTEND_COLUMNLIST({tableName:'saas_truckinfo','modulename':'manage',queryType:3})).then(() => {
...
export default CommonBusinessVehicleView;
