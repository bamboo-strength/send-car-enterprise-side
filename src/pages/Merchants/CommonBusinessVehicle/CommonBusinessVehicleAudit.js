...
@Form.create()
class CommonBusinessVehicleAudit extends PureComponent {
  ...
  handleAccpet = e => {
    ...
    form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        auditData({auditStatus:1, ids:id, remark:values.remark }).then(resp => {
          this.setState({
            loading: false,
          });
          if (resp.success) {
...
export default CommonBusinessVehicleAudit;
