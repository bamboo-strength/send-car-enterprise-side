    ...
    routes: [
      {
        path: '/base/goods',
        routes: [
          { path: '/base/goods', redirect: '/base/goods/list' },
          { path: '/base/goods/list', component: './Base/Goods/GoodsList' },
          { path: '/base/goods/add', component: './Base/Goods/GoodsAdd' },
          { path: '/base/goods/edit/:id', component: './Base/Goods/GoodsEdit' },
          { path: '/base/goods/view/:id', component: './Base/Goods/GoodsView' },
        ],
      },
      {
        path: '/base/customer',
