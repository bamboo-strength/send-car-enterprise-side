...
const proxy = {
  'GET /api/shipper-system/client/list': getFakeList,
  'GET /api/shipper-system/client/detail': getFakeDetail,
  'POST /api/shipper-system/client/submit': fakeSuccess,
  'POST /api/shipper-system/client/remove': fakeSuccess,
};
